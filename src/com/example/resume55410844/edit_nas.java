...
public class edit_nas extends Activity implements OnClickListener {
...
etxt1 = (EditText) findViewById(R.id.etx1);
etxt2 = (EditText) findViewById(R.id.etx2);
etxt3 = (EditText) findViewById(R.id.etx3);
etxt4 = (EditText) findViewById(R.id.etx4);
etxt5 = (EditText) findViewById(R.id.etx5);
etxt6 = (EditText) findViewById(R.id.etx6);
etxt7 = (EditText) findViewById(R.id.etx7);
}
@Override
